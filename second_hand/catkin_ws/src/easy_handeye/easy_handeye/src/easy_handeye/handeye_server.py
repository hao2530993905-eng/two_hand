...
class HandeyeServer:
    def __init__(self, namespace=None):
        ...
        # The rqt client removes indexed samples through the service with this
        # resolved name. A second Empty subscriber can make one click delete
        # two samples, so do not subscribe to REMOVE_SAMPLE_TOPIC here.
